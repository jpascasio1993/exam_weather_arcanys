...
/// @nodoc
abstract class _$$_RequestStateStateCopyWith<T, $Res>
    implements $RequestStateStateCopyWith<T, $Res> {
  factory _$$_RequestStateStateCopyWith(_$_RequestStateState<T> value,
          $Res Function(_$_RequestStateState<T>) then) =
      __$$_RequestStateStateCopyWithImpl<T, $Res>;
  @override
  @useResult
  $Res call(
      {StoreState storeState,
...
/// @nodoc
class __$$_RequestStateStateCopyWithImpl<T, $Res>
    extends _$RequestStateStateCopyWithImpl<T, $Res, _$_RequestStateState<T>>
    implements _$$_RequestStateStateCopyWith<T, $Res> {
  __$$_RequestStateStateCopyWithImpl(_$_RequestStateState<T> _value,
      $Res Function(_$_RequestStateState<T>) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_RequestStateState<T>(
      storeState: null == storeState
          ? _value.storeState
          : storeState // ignore: cast_nullable_to_non_nullable
              as StoreState,
...
class _$_RequestStateState<T> implements _RequestStateState<T> {
  const _$_RequestStateState(
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_RequestStateState<T> &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_RequestStateStateCopyWith<T, _$_RequestStateState<T>> get copyWith =>
      __$$_RequestStateStateCopyWithImpl<T, _$_RequestStateState<T>>(
          this, _$identity);
}
...
abstract class _RequestStateState<T> implements RequestStateState<T> {
  const factory _RequestStateState(
      ...
      final bool isLoading,
      final bool hasError,
      final Exception? exception}) = _$_RequestStateState<T>;
